...
const printOn = (e) => {
  e.preventDefault();
  emptify();
  $('#printForm').toggleClass('displayOn');
};
const verifyOn = (e) => {
  e.preventDefault();
  emptify();
  $('#verifyForm').toggleClass('displayOn');
};
const lookupOn = (e) => {
  e.preventDefault();
  emptify();
  $('#lookupForm').toggleClass('displayOn');
};
const addOn = (e) => {
  e.preventDefault();
  emptify();
  $('#addForm').toggleClass('displayOn');
};
const containsOn = (e) => {
  e.preventDefault();
  emptify();
  $('#containsForm').toggleClass('displayOn');
};
const updateOn = (e) => {
  e.preventDefault();
  emptify();
  $('#updateForm').toggleClass('displayOn');
};
const deleteOn = (e) => {
  e.preventDefault()
  emptify();
  $('#deleteForm').toggleClass('displayOn');
};
...
const addfy = (e) => {
  ...
  let addArr = [{name: addName, officeNum: addNum, phoneNum: addPhone}];
